...
my @beer2 = (
    "beer002", "beer003", "beer004", "beer011", "beer013", "beer021", "beer027", "beer032",
    "beer034", "beer039", "beer040", "beer059", "beer062", "beer063", "beer080", "beer083",
...
for my $line ( Path::Tiny::path($file_snp)->lines( { chomp => 1, } ) ) {
    ...
    print
        join( ",", ( $fields[0], $asian_mean, $wine_mean, $beer1_mean, $beer2_mean, $mixed_mean ) ),
        "\n";
}
