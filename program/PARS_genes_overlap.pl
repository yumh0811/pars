...
=head1 SYNOPSIS
    ...
    perl ~/Scripts/pars/program/PARS_genes_overlap.pl --file ~/data/mrna-structure/phylogeny/PARS_genes_list_range_chr_strand.csv --output ~/data/mrna-structure/phylogeny/PARS_genes_overlap.csv
