...
=head1 SYNOPSIS
    ...
    perl ~/Scripts/pars/program/protein_coding_overlap_yml.pl --file ~/data/mrna-structure/phylogeny/protein_coding_overlap.csv --output ~/data/mrna-structure/phylogeny/overlap.yml
