...
data_SNPs_PARS_syn_nodom <- merge(data_SNPs_PARS_syn,data_gene_nodom,by="gene")
...
data_SNPs_PARS_syn_limdom <- merge(data_SNPs_PARS_syn,data_gene_limdom,by="gene")
...
data_SNPs_PARS_syn_strdom <- merge(data_SNPs_PARS_syn,data_gene_strdom,by="gene")


group = c("syn_nodom","syn_limdom","syn_strdom")
for (g in group){
