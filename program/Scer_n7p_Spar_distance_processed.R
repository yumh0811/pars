...
data_gene_range = read.csv("~/data/mrna-structure/phylogeny/Scer_n7p_Spar_gene_range.csv",head=TRUE)
...
write.csv(data_out_1,file="~/data/mrna-structure/phylogeny/Scer_n7p_Spar_distance_processed_pro_1.csv",row.names = FALSE)
